...
CREATE TABLE `playlists` (
  ...
  KEY `genreId` (`genreId`),
  KEY `userId` (`userId`),
  CONSTRAINT `playlists_ibfk_111` FOREIGN KEY (`genreId`) REFERENCES `genres` (`id`) ON DELETE
  SET
    NULL ON UPDATE CASCADE,
    CONSTRAINT `playlists_ibfk_112` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE
  SET
    NULL ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE `room_chat` (
  ...
  KEY `roomId` (`roomId`),
  KEY `userId` (`userId`),
  CONSTRAINT `room_chat_ibfk_1` FOREIGN KEY (`roomId`) REFERENCES `rooms` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `room_chat_ibfk_2` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON UPDATE CASCADE
...
--
-- Table structure for table `room_current_playing`
--
DROP TABLE IF EXISTS `room_current_playing`;
...
CREATE TABLE `room_current_playing` (
  `roomId` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `songId` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  KEY `songId` (`songId`),
  CONSTRAINT `room_current_playing_ibfk_1` FOREIGN KEY (`roomId`) REFERENCES `rooms` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `room_current_playing_ibfk_2` FOREIGN KEY (`songId`) REFERENCES `songs` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE `room_members` (
  ...
  KEY `userId` (`userId`),
  CONSTRAINT `room_members_ibfk_1` FOREIGN KEY (`roomId`) REFERENCES `rooms` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `room_members_ibfk_2` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
--
-- Table structure for table `room_song`
--
...
CREATE TABLE `room_song` (
  ...
  PRIMARY KEY (`roomId`, `songId`),
  KEY `songId` (`songId`),
  CONSTRAINT `room_song_ibfk_1` FOREIGN KEY (`roomId`) REFERENCES `rooms` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `room_song_ibfk_2` FOREIGN KEY (`songId`) REFERENCES `songs` (`id`) ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE `rooms` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`),
  CONSTRAINT `rooms_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE
  SET
    NULL ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE `songs` (
  ...
  CONSTRAINT `songs_ibfk_108` FOREIGN KEY (`genreId`) REFERENCES `genres` (`id`) ON DELETE
  SET
    NULL ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
-- Dump completed on 2024-12-20 14:19:19